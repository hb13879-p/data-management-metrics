...
from profiler.metrics import BasicProfile, TotalBlankCells, TotalRowsCols, DuplicateRows, DetectBadAddress, ExtractBadPostcode, GroupedZScore, SupervisedAnomalyDetection, ClassifyClientNotes
from profiler.sql_connectors import SQLViewConnector
...
class CSVMetricTestsBCM(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        csv_reader = CSVReader(r'C:/Users/hbinning/Documents/data_profiling_tool/app/files','mortgage_data_v4.csv')
    ...
    def test_basic_profile_column_views_csv(self):
        ...
        self.assertIsInstance(csv_basic_profile.get_result_for_column('card_type'), dict)
...
class CSVMetricTestsIns(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        csv_reader = CSVReader(r'C:/Users/hbinning/Documents/data_profiling_tool/app/files','insurance_data.csv')
        cls.data_source = InMemoryDataSource(csv_reader)        
