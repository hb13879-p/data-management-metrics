...
class SQLTableReader(SQLViewConnector, TabularDataReader):
    ...
    def __init__(self, sql_dialect: str, db_creds: Dict[str,str], table_name: str = None, custom_sql: str = None):
        super().__init__(sql_dialect, db_creds, table_name=table_name, custom_sql=custom_sql)
        self.read_in_data()

    def read_in_data(self):
        self.data = self.sql_connector.run_query(self.main_query_sql, params = self.main_query_params)
