...
class StandardDashboard(Dashboard):
    ...
    '''
    def __init__(self, column_views: Metric, data_rules: Metric, anomaly_detect: Metric, extract_bad_postcode: Metric, ml_address: Metric, headline_metrics: List[Metric], ml_client_notes: Metric):
        super().__init__()
        ...
        self.add_metrics([column_views, data_rules, anomaly_detect, extract_bad_postcode, ml_address, *headline_metrics, ml_client_notes])
    ...
    def populate_headline_metrics(self):
        ...
        if not (len(self.headline_metric_labels) == len(self.headline_metric_results) == len(self.headline_metric_icons) == len(self.headline_metric_colours)):
    ...
    def get_headline_metrics(self):
        return self.headline_metric_results, self.headline_metric_labels, self.headline_metric_icons, self.headline_metric_colours
